...
author: "Namik Taright"
institute: "AP-HP, France"
...
library(metathis)
meta() %>%
  meta_name("github-repo" = "NamikTaright/Formation") %>% 
  meta_social(
    title = "Cartographie primaire",
    description = paste(
      "Apprendre à faire un peude cartographie avec R.",
      "Presenté lors d'une formation R/AP-HP."
    ),
